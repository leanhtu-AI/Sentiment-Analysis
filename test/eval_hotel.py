...
reloaded_model.load_weights(f'{MODEL_PATH}/hotel.h5')
y_pred = predict_test(reloaded_model, test_hotel_dataset, BATCH_SIZE, verbose=1)
reloaded_model.evaluate(test_hotel_dataset  , batch_size=BATCH_SIZE, verbose=1)
