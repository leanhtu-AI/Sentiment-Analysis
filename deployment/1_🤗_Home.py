...
if choice == 'Home':
    ...
    if file:
        ...
        df.to_csv('C:/Users/FPTSHOP/OneDrive/Documents/SAV/deployment/data/source.csv', index=None)
        st.dataframe(df)
...
#     else:       
    ...
    input_path = "C:/Users/FPTSHOP/OneDrive/Documents/SAV/deployment/data/source.csv"
    output_path = "C:/Users/FPTSHOP/OneDrive/Documents/SAV/deployment/data/raw.csv"
    ...
    df_clean.to_csv("C:/Users/FPTSHOP/OneDrive/Documents/SAV/deployment/data/cleandata.csv", index = False)
    ...
    DATA_PATH = "C:/Users/FPTSHOP/OneDrive/Documents/SAV/deployment/data/cleandata.csv"
