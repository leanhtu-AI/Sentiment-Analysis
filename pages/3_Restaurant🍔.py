...
from predict_res import process_predict_csv, show_predict_csv, show_predict_text
from preprocess_user_data import auto_detect_filter_data, preprocess_data, sentiments_frequency, take_info_res
...
def plot_sentiment_frequencies(sentiment_df):
    ...
    st.pyplot(fig)
lottie_cook = load_lottiefile("lottiefiles/cook.json")
# sidebar decoration
with st.sidebar:
    st_lottie(lottie_cook, speed=1, loop=True, quality="low")
